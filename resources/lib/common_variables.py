...
#youtube
channel_id = "UC2Th9fjegtGqBQ7UMXTDWuQ"
...
#youtube channel
cast = ['Professional Skaters'] #Team members / Cast of the channel. [] if none
tvshowtitle = 'Street League Skateboarding' #Name of the show
